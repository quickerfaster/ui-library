...
> - **Category A** (Missing Module Internals): Context group overview views and Data configs created for Admin, System, and Organization (see §0.11 of [`implementation-plan.md`](./implementation-plan.md))
...
> - **Category C** (View/Routing Interplay): Catch-all route interaction documented in [`docs/ai-optimized-architecture-blueprint.md`](./ai-optimized-architecture-blueprint.md) and [`docs/phase-4.1-organization-extraction-spec.md`](./phase-4.1-organization-extraction-spec.md)
> See [`docs/pre-phase-4-remediation-plan.md`](./pre-phase-4-remediation-plan.md) for detailed resolution steps.
...
|----------|-------|-------------|
| [`docs/decoupling-migration-plan.md`](./decoupling-migration-plan.md) | 2,133 | Defines what SHOULD be moved from `app/Modules/*` to `src/Core/*` |
| [`docs/ai-optimized-architecture-blueprint.md`](./ai-optimized-architecture-blueprint.md) | 2,888 | Defines the canonical module pattern, catch-all routing, and config-driven architecture |
| [`docs/phase-4.1-organization-extraction-spec.md`](./phase-4.1-organization-extraction-spec.md) | 1,213 | Defines the Organization extraction target structure |
| [`docs/implementation-plan.md`](./implementation-plan.md) | 1,675 | Tracks completed phases and remaining gaps |
