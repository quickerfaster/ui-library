...
> ⚠️ **SUPERSEDED** — This file has been split into 17 topic files under [`docs/architecture/`](../README.md). See [`00-index.md`](../README.md) for the authoritative index. This file is retained as historical reference only.
...
| Override library view | `resources/views/vendor/qf/` | `src/Providers/UILibraryServiceProvider.php` (publish tag) |
...
- **Phase 4.6**: 🔄 In Progress — Architecture Blueprint Restructure. [`00-index.md`](../README.md) created as authoritative index; 16 topic files deferred. This blueprint remains single source of truth.
