...
**Related files**: [`08-contracts-and-interfaces.md`](./08-contracts-and-interfaces.md) · [`10-settings-and-config.md`](./10-settings-and-config.md) · [`14-integration-map.md`](./14-integration-map.md)

> **Consuming-app developers**: For usage examples, contract cookbook recipes, and engine how-to guides, see [../consuming-app/contracts.md](../consuming-app/contracts.md). The full contract method signatures live in [`08-contracts-and-interfaces.md`](./08-contracts-and-interfaces.md).
...
> **Cross-links**: Full contract method signatures live in [`08-contracts-and-interfaces.md`](./08-contracts-and-interfaces.md) (referenced, not duplicated here).
...
Polymorphic, config-driven document management engine. Any Eloquent model can become document-enabled by implementing the [`Documentable`](../../src/Contracts/Documents/Documentable.php) contract.
...
- **Trait**: [`HasDocuments`](../../src/Traits/Documents/HasDocuments.php) — recommended convenience trait for models implementing `Documentable`. Provides `documents()`, `uploadDocument()`, `getDocuments()`, `deleteDocument()` — wrapping [`DocumentEngine`](../../src/Services/Documents/DocumentEngine.php) for cleaner model integration. See [../consuming-app/contracts.md](../consuming-app/contracts.md) §3.3 for usage examples.
...
| `document_type` | string | Category key (e.g., `contract`) |
