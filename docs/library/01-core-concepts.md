...
**Related files**: [`00-index.md`](../README.md) · [`02-directory-map.md`](./02-directory-map.md) · [`03-module-pattern.md`](./03-module-pattern.md) · [`13-adr.md`](./13-adr.md)
...
| Publishable tag | `ui-library-*` | `php artisan vendor:publish --tag=ui-library-views` |

> **View publish paths**: `ui-library-views` publishes to `resources/views/vendor/qf/`, and `ui-library-core-views` publishes core module (Admin/System) views to `resources/views/vendor/qf-core/{module}/`.
...
**Related files**: [`00-index.md`](../README.md) · [`02-directory-map.md`](./02-directory-map.md) · [`03-module-pattern.md`](./03-module-pattern.md) · [`13-adr.md`](./13-adr.md) · [`15-gaps-and-recommendations.md`](./15-gaps-and-recommendations.md)
