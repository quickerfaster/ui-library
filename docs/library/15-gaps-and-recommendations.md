...
**Related files**: [`00-index.md`](../README.md) · [`13-adr.md`](./13-adr.md) · [`16-phase-history.md`](./16-phase-history.md) · [`17-view-config-routing-interplay.md`](./17-view-config-routing-interplay.md) · [`26-module-auto-discovery.md`](./26-module-auto-discovery.md)
...
| 10.8 | Caching Strategy for Module Discovery | Performance — ✅ Resolved (2026-08-17) |
...
## 10.8 Caching Strategy for Module Discovery — ✅ RESOLVED (2026-08-17)

**Gap**: The [`ModuleServiceProvider`](../../src/Providers/ModuleServiceProvider.php) scanned modules dynamically on every request in non-production environments. Event listener discovery had production caching, but the broader discovery surface did not.

**Resolution**: The new [`DiscoveryRegistrar`](../../src/Services/Discovery/DiscoveryRegistrar.php) centralizes auto-discovery (listeners, reports, workflows, permissions, notifications) with a content-hash caching strategy:

1. **Content-hashed cache keys** derived from candidate file paths + mtimes, so caches self-invalidate whenever a file is added, removed, or changed on deploy.
2. **Finite TTL** via `ui-library.discovery.cache_ttl` (default 86400s) — the library never uses `Cache::forever()` for discovery.
3. **Dev/test always re-scan** so tests observe fresh state without a manual cache flush.

> **Related**: [`26-module-auto-discovery.md`](./26-module-auto-discovery.md) documents the full caching policy and opt-outs.
...
**Related files**: [`00-index.md`](../README.md) · [`13-adr.md`](./13-adr.md) · [`16-phase-history.md`](./16-phase-history.md) · [`17-view-config-routing-interplay.md`](./17-view-config-routing-interplay.md) · [`11-extension-guide.md`](./11-extension-guide.md) · [`26-module-auto-discovery.md`](./26-module-auto-discovery.md)
