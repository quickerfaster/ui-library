...
**Related files**: [`00-index.md`](./00-index.md) · [`09-engines-and-services.md`](./09-engines-and-services.md) · [`15-gaps-and-recommendations.md`](./15-gaps-and-recommendations.md) · [`17-view-config-routing-interplay.md`](./17-view-config-routing-interplay.md) · [`../implementation-plan.md`](../implementation-plan.md)
...
| **4.6** | 🔄 | Architecture Blueprint Restructure — topic-file split (this file set) | [`00-index.md`](./00-index.md) |
