...
**Related files**: [`09-engines-and-services.md`](./09-engines-and-services.md) (Notification Engine §14) · [`08-contracts-and-interfaces.md`](./08-contracts-and-interfaces.md) · [`18-workflow-approval-testing-checklist.md`](./18-workflow-approval-testing-checklist.md)
...
The library's catch-all route `/{module}/{view}/{id?}` (see [`17-view-config-routing-interplay.md`](./17-view-config-routing-interplay.md)) is now hardened with config-driven gates under `ui-library.catch_all`. Consuming apps may want to review and override these when publishing the config:
...
The full schema is documented in [`10-settings-and-config.md`](./10-settings-and-config.md) under "Catch-All Route Security".

---

**Related files**: [`09-engines-and-services.md`](./09-engines-and-services.md) · [`08-contracts-and-interfaces.md`](./08-contracts-and-interfaces.md) · [`18-workflow-approval-testing-checklist.md`](./18-workflow-approval-testing-checklist.md) · [`00-index.md`](./00-index.md) · [`10-settings-and-config.md`](./10-settings-and-config.md) · [`17-view-config-routing-interplay.md`](./17-view-config-routing-interplay.md)
