...
│  resources/views/vendor/ui-library/ ← OPTIONAL overrides         │
└──────────────────────────────────────────────────────────────────┘
```
...
return [
    ...
    */
    ...
    | ui-library-views        → resources/views/vendor/ui-library/
    | ui-library-core-views   → resources/views/vendor/ui-library/core/
...
Published Views (customizable):
  resources/views/vendor/ui-library/core/{module}/  → overrides Core module views
  resources/views/vendor/ui-library/                → overrides library views
```
...
private function bootCoreModules(): void
{
    ...
    foreach (['Admin', 'System'] as $module) {
        ...
        if (is_dir($viewPath)) {
            ...
            $this->publishes([
                $viewPath => resource_path('views/vendor/ui-library/core/' . strtolower($module)),
...
1. First checks `resources/views/vendor/ui-library/core/{module}/` (published override)
...
Then edit files in:
- `resources/views/vendor/ui-library/core/admin/dashboard.blade.php`
- `resources/views/vendor/ui-library/auth/login.blade.php`
- etc.
...
| `ui-library-views` | `resources/views/vendor/ui-library/` | Auth, layout, component views |
| `ui-library-core-views` | `resources/views/vendor/ui-library/core/` | Admin & System module views |
