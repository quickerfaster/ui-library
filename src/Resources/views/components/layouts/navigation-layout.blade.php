...
<head>
    ...
    <link id="qf-styles" href="{{ asset('vendor/ui-library/assets/css/quicker-faster.css') }}?v=1.0.5" rel="stylesheet" />
        ...
        <div class="mt-5">
            ...
            @else
                ...
                <div class="d-flex align-items-start main-content-wrapper">
                    ...
                    <main class="flex-grow-1 px-4 pb-md-3" style="min-width: 0; padding-bottom: 8rem;">
                        {{-- ========== HEADER SECTION ========== --}}
                        @include('qf::components.layouts.partials.page-header')
                        {{ $slot }}
                    </main>
