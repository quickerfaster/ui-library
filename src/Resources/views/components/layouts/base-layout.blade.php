...
<head>
    ...
    <title>{{ $title ?? config('app.name') }}@include('qf::components.layouts.partials.company-title-suffix')</title>
...
<body>
    ...
    <script src="{{ asset('bootstrap/assets/js/plugins/flatpickr.min.js') }}"></script>
